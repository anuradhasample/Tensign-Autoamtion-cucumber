 ...
 */
const copyFileToWatch = (input, allureResultsWatch) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield (0, fs_tools_1.copyAttachments)(attachments, allureResultsWatch, allureResultFile);
    yield (0, fs_tools_1.copyTest)(allureResultFile, allureResultsWatch);
});
/**
...
class AllureReporter {
    ...
    attachVideoToContainers(arg) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let doneFiles = 0;
            (0, fs_1.readFile)(videoPath, errVideo => {
                if (errVideo) {
                ...
                testsAttach.forEach(test => {
                    ...
                    (0, fs_1.readFile)(containerFile, (err, contents) => {
                        if (err) {
                        ...
                        const writeContainer = () => {
                            ...
                            (0, fs_tools_1.writeResultFile)(containerFile, newContent, () => {
                        ...
                        (0, fs_tools_1.copyFileCp)(videoPath, newPath, false, () => {
                            writeContainer();
                        });
                    });
                });
            });
            yield (0, fs_tools_1.waitWhileCondition)(() => doneFiles < testsAttach.length);
        });
    }
    endGroup() {
        var _a;
    ...
    endTests() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const _tst of this.tests) {
                yield this.endTest({ result: allure_types_1.UNKNOWN, details: undefined });
            }
        });
    }
    endGroups() {
    ...
    endTest(arg) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            */
            ...
            yield copyFileToWatch({ test: testFile, attachments }, this.allureResultsWatch);
        });
    }
    startStep(arg) {
        const { name, date } = arg;
